...
**PITFALL — File permissions**: `warroom.html` (if served as static) and any new static file created by root defaults to `600` → nginx returns 403. Always `chmod 644` after creating files in `/var/www/hermesbro/`.
